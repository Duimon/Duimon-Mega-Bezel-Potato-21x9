...
The folder structure is...
    ...
    Retroarch/shaders/Mega_Bezel_Packs/Duimon-Mega-Bezel-Potato-21x9
        	/Graphics
        	/Presets
...
```
git clone https://github.com/Duimon/Duimon-Mega-Bezel-Potato-21x9
```

It will create a *"Duimon-Mega-Bezel-Potato-21x9"* folder inside the *"Mega_Bezel_Packs"* folder. 

To update, go into the *"Duimon-Mega-Bezel-Potato-21x9"* folder (note the path difference) and run
